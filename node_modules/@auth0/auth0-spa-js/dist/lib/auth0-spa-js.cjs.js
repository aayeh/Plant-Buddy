            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.cache.set(this.manifestKey, { keys: __spreadArray([], __read(keys), false) })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        authResult = _a.sent();
                        organizationId = options.organization || this.options.organization;
                        return [4 /*yield*/, this._verifyIdToken(authResult.id_token, nonceIn, organizationId)];
                    case 4:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 8: throw e_2;
                    case 9: return [4 /*yield*/, this._verifyIdToken(tokenResult.id_token)];
                    case 10:
                        decodedToken = _a.sent();
                        return [2 /*return*/, __assign(__assign({}, tokenResult), { decodedToken: decodedToken, scope: options.scope, oauthTokenScope: tokenResult.scope, audience: options.audience || 'default' })];
                }
            });
        });
    };
